...
VALUES (2, 'Clinica San Pablo Surco', 'Clinica San Pablo sede Surco',NULL, TRUE,'Av. El Polo 789, Surco');
INSERT INTO location(enterprise_id, name, description, picture_url, is_enabled, postal_address)
VALUES (2, 'Clinica San Pablo Trujillo', 'Clinica San Pablo sede Trujillo',NULL, TRUE,null);
INSERT INTO location(enterprise_id, name, description, picture_url, is_enabled, postal_address)
VALUES (2, 'Clinica San Pablo Huaraz', 'Clinica San Pablo sede Huaraz ',NULL, TRUE,null);
...
VALUES (1,1 ,'777666','Nutricionista','Cory Perez','1985-01-01',
'https://s3.amazonaws.com/midocvirtual/image-dev/doctor/doctor_female.png','coryperez@gmail.com','coryp','123456','ESPEC',TRUE );


insert INTO doctor( emergency_attention_id, location_id, cmd_peru, degree, doctor_name, year_of_birth,
picture_url, email, midoc_user, password, type_of_specialist, is_enabled)
VALUES (3,1 ,'777666','Nutricionista','Pedro JuanPablo','1985-01-01',
'https://res.cloudinary.com/dzthuikyb/image/upload/v1500998377/doctor_02_nwodq0.jpg','pedrojuanpi@gmail.com','pedroj','123456','ESPEC',TRUE );


insert INTO doctor( emergency_attention_id, location_id, cmd_peru, degree, doctor_name, year_of_birth,
picture_url, email, midoc_user, password, type_of_specialist, is_enabled)
VALUES (1,1 ,'777666','Nutricionista','Nicholas Gatjens','1985-01-01',
'https://s3.amazonaws.com/midoc-dev/doctors-img/Nicholas.jpg','⁠⁠⁠ngatjens@gmail.com','nicholasg','123456','ESPEC',TRUE );
